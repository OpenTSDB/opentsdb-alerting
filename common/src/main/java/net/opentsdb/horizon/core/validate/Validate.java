...
package net.opentsdb.horizon.core.validate;

/**
 * TODO: Might need to rewrite due to license issues as it is taken from
 * https://github.com/aws/aws-sdk-java-v2/blob/master/utils/src/main/java/software/amazon/awssdk/utils/Validate.java
 */
