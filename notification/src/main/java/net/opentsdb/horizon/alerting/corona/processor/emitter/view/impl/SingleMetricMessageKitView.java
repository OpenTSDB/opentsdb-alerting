...
public class SingleMetricMessageKitView
        extends MessageKitView<SingleMetricAlert, SingleMetricAlertView> {

    public SingleMetricMessageKitView(final MessageKit messageKit) {
        super(messageKit);
    }

    @Override
    protected SingleMetricAlertView getViewOf(final SingleMetricAlert alert) {
        return Views.of(alert);
    }

    @Override
    public String interpolateSubject(SingleMetricAlertView alertView) {
        return super.interpolateSubject(alertView.getSortedTags());
    }

    @Override
    public String interpolateBody(SingleMetricAlertView alertView) {
