...
import net.opentsdb.horizon.alerting.corona.processor.emitter.prism.PrismFormatter;
import net.opentsdb.horizon.alerting.corona.processor.emitter.prism.formatter.PrismEventAlertFacade;
import net.opentsdb.horizon.alerting.corona.processor.emitter.prism.formatter.PrismHealthCheckAlertFacade;
import net.opentsdb.horizon.alerting.corona.processor.emitter.prism.formatter.PrismPeriodOverPeriodAlertFacade;
import net.opentsdb.horizon.alerting.corona.processor.emitter.prism.formatter.PrismSingleMetricAlertFacade;
...
public class DefaultPrismFormatter implements PrismFormatter {

    private final String hostname;

    private DefaultPrismFormatter(final DefaultBuilder builder) {
        Objects.requireNonNull(builder.hostname, "hostname cannot be null");
        this.hostname = builder.hostname;
    }

    @Override
    public PrismEvent format(final MessageKitView messageKit,
                             final AlertView alertView,
                             final OcMeta meta,
                             final OcContact contact) {
        if (alertView instanceof SingleMetricAlertView) {
            return new PrismSingleMetricAlertFacade(
                    hostname,
            ...
            return new PrismEventAlertFacade(
                    hostname,
            ...
            return new PrismPeriodOverPeriodAlertFacade(
                    hostname,
    ...
    public interface Builder extends PrismFormatter.Builder<Builder> {
    ...
    private static final class DefaultBuilder implements Builder {
        ...
        @Override
        public PrismFormatter build() {
            return new DefaultPrismFormatter(this);
        }
    }
