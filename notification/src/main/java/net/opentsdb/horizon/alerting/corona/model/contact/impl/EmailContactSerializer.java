...
public class EmailContactSerializer
        extends AbstractContactSerializer<EmailContact, EmailContact.Builder<?>>
{

    public EmailContactSerializer()
    {
        super(EmailContact::builder);
    }

    @Override
    protected Class<EmailContact> getSerializableClass()
    {
    ...
    @Override
    protected void readAddedFields(final EmailContact.Builder<?> builder,
                                   final Kryo kryo,
                                   final Input input,
                                   final Class<EmailContact> type)
    {
