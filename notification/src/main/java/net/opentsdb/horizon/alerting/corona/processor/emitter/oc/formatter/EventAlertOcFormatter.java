...
public class EventAlertOcFormatter
        ...
        >
{
    ...
    public EventAlertOcFormatter(final String colo, final String host)
    {
        super(colo, host);
    }
    ...
    @Override
    protected StringBuilder buildAppDescriptionPrefix(final StringBuilder sb,
                                                      final EventAlertView view)
    {
