...
public class EventMessageKitView extends MessageKitView<EventAlert, EventAlertView> {

    /* ------------ Fields ------------ */

    /* ------------ Constructors ------------ */

    public EventMessageKitView(final MessageKit messageKit) {
        super(messageKit);
    }
    ...
    @Override
    protected EventAlertView getViewOf(final EventAlert alert) {
        return Views.of(alert);
    }

    @Override
    public String interpolateSubject(EventAlertView alertView) {
        return super.interpolateSubject(alertView.getSortedTags());
    }

    @Override
    public String interpolateBody(EventAlertView alertView) {
