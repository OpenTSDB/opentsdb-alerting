...
public class PeriodOverPeriodAlertOcFormatter
    ...
    public PeriodOverPeriodAlertOcFormatter(String colo, String host) {
        super(colo, host);
    }

    @Override
    protected StringBuilder buildAppDescriptionPrefix(StringBuilder sb, PeriodOverPeriodAlertView view) {
    ...
    protected String buildMessageSnippet(
            ...
            final PeriodOverPeriodAlertView view) {
