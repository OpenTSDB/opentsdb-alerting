...
public interface PrismFormatter {

    PrismEvent format(MessageKitView mk, AlertView av, OcMeta meta, OcContact contact);

    interface Builder<B extends Builder<B>>
            extends net.opentsdb.horizon.alerting.Builder<B, PrismFormatter> {
