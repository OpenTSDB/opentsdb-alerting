        ...
        extends SlackAbstractFormatter<HealthCheckAlert, HealthCheckAlertView, HealthChekMessageKitView>
{
    ...
    @Override
    protected String generateAttachmentText(final HealthCheckAlertView view)
    {
        final String header = "_Tags:_ " + formatTags(view.getSortedTags());

        final String statusMessage = view.getStatusMessage();
        final String message = statusMessage == null ? "_empty_" : statusMessage;
        return header + "\n" +
                "*Message:*  " + message;
    }
}
