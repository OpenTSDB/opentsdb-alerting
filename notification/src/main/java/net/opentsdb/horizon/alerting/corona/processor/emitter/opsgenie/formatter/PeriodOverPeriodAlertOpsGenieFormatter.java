...
public class PeriodOverPeriodAlertOpsGenieFormatter
    ...
    public PeriodOverPeriodAlertOpsGenieFormatter(String user, String source) {
        super(user, source, "templates/opsgenie-period-over-period-alert.html");
    }
